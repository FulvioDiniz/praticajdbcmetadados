...
public class ConexãoBD {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println();
            try (ResultSet resultSet = dbmd.getColumns(null, null, "teste", null)) {
            ...
            System.out.println();
            try (Statement stmt = conexao.createStatement(); ResultSet rs = stmt.executeQuery("SELECT * FROM teste")) {
